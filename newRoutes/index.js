let passport = require('passport'), // eslint-disable-line no-unused-vars
	...
	var passportTwitter = require('../auth/twitter');// eslint-disable-line no-unused-vars
  	var passportGoogle = require('../auth/google');// eslint-disable-line no-unused-vars
	var passportReddit = require('../auth/reddit');// eslint-disable-line no-unused-vars
	var passportTumblr = require('../auth/tumblr');// eslint-disable-line no-unused-vars
...
module.exports = () => {
	...
	app.get('/auth/tumblr', passportTumblr.authenticate('tumblr'));
	app.get('/auth/tumblr/callback',
		passportTumblr.authenticate('tumblr', { failureRedirect: '/observe' }),
		function (req, res) {
			res.redirect('/game');
		});

	app.get('/auth/google', passportGoogle.authenticate('google', { scope: ['openid',  'email' , 'profile'] }));
	app.get('/auth/google/callback',
		passportGoogle.authenticate('google', { failureRedirect: '/observe' }),
		function (req, res) {
			res.redirect('/game');
		});
};